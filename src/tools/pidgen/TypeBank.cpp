...
initTypeBank(SKeyedVector<SString, sptr<IDLType> >& tb)
{
	...
	SKeyedVector<SString, uint32> stdtypes;
	...
	stdtypes.AddItem(SString("int32"), B_INT32_TYPE);				
	stdtypes.AddItem(SString("int64"), B_INT64_TYPE);				
	// 5-11 : std types where X-> Int32(var) & (x)var.AsInt32();
	stdtypes.AddItem(SString("int8"), B_INT8_TYPE);				
	stdtypes.AddItem(SString("int16"), B_INT16_TYPE);				
	stdtypes.AddItem(SString("uint8"), B_UINT8_TYPE);				
	stdtypes.AddItem(SString("uint16"), B_UINT16_TYPE);			
	stdtypes.AddItem(SString("uint32"), B_UINT32_TYPE);			
	...
	stdtypes.AddItem(SString("uint64"), B_UINT64_TYPE);			
	...
	stdtypes.AddItem(SString("BString"), B_STRING_TYPE);
	stdtypes.AddItem(SString("BMessage"), B_MESSAGE_TYPE);
